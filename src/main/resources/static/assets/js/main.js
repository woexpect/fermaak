...
(function($) {
	...
	// Ready event.
		$(function() {
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("0",37,53);
			//=======================================================
			ctx.beginPath();
			ctx.arc(80,50,10,0,2*Math.PI);
			ctx.font = "30px Arial";
			ctx.fillStyle = "#D13700";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("3",77,53);
			//=======================================================
			ctx.beginPath();
			ctx.arc(40,120,10,0,2*Math.PI);
			ctx.fillStyle = "#D13700";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("3",37,193);
			//=======================================================
			ctx.beginPath();
			ctx.arc(80,190,10,0,2*Math.PI);
			ctx.fillStyle = "#00D3CC";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("0",77,193);
			//=======================================================
			//=======================================================
			ctx.beginPath();
			ctx.arc(40,260,10,0,2*Math.PI);
			ctx.fillStyle = "#00D3CC";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("0",37,263);
			//=======================================================
			ctx.beginPath();
			ctx.arc(80,260,10,0,2*Math.PI);
			ctx.fillStyle = "#00D3CC";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("0",77,263);
			//=======================================================
			//barras=======================================================
			ctx.beginPath();
			ctx.arc(28,347,10,0,2*Math.PI);
			ctx.fillStyle = "#D13700";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("2",25,352);
			//=======================================================
			ctx.beginPath();
			ctx.arc(49,347,10,0,2*Math.PI);
			ctx.fillStyle = "#00D3CC";
			ctx.fill();
			ctx.stroke();
			...
			ctx.fillStyle = 'white';
			ctx.fill();
			ctx.fillText("0",46,352);
			//=======================================================
			ctx.beginPath();
			ctx.arc(71,347,10,0,2*Math.PI);
			ctx.fillStyle = "#D13700";
			ctx.fill();
			ctx.stroke();
